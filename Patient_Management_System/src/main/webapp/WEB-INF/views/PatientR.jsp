...
<body>
	<header>
		<a href="http://localhost:8080/Patient_Management_System/main"><img src="image/HomeIcon.jpg" alt="homeicon"
			class="icon" /></a>
	</header>
	<a href="http://localhost:8080/Patient_Management_System/patientlogin"><img src="image/Login.jpg" class="login" alt="Login" /></a>
